...
int main(void)
{
  ...
  osThreadDef(MyTask1, StartTask1, osPriorityBelowNormal, 0, 128);
  ...
  osThreadDef(MyTask3, StartTask3, osPriorityAboveNormal, 0, 128);
...
void SendStrings(char *pcString)
{
  HAL_UART_Transmit(&huart1, (uint8_t *)pcString, strlen(pcString), 500);
}
/* USER CODE END 4 */
...
{
  /* USER CODE BEGIN 5 */
char *pcTask1String = "Task 1 is running!\r\n";
  /* Infinite loop */
  for(;;)
  {
    SendStrings(pcTask1String);
    osDelay(1000);
  }
  /* USER CODE END 5 */
}
...
char *pcTask2String = "Task 2 is running!\r\n";
  /* Infinite loop */
  for(;;)
  {
    SendStrings(pcTask2String);
    osDelay(1000);
  }
...
char *Task3Strings = "Task 3 is running!\r\n";
  /* Infinite loop */
  for(;;)
  {
    SendStrings(Task3Strings);
    osDelay(1000);
  }
